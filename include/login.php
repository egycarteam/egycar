...
input[type="submit"] {
    ...
    box-shadow: rgba(0, 0, 0, 0) 0px 0px 0px 0px, 
                ...
                rgb(34, 136, 255) 0px 0px 0px 1px, 
                rgba(0, 0, 0, 0) 0px 0px 0px 0px, 
                rgba(0, 0, 0, 0) 0px 0px 0px 0px, 
    ...
    <div class="box-root flex-flex flex-direction--column" style="min-height: 100vh;flex-grow: 1;">
      ...
      <div class="box-root padding-top--24 flex-flex flex-direction--column" style="flex-grow: 1; z-index: 9;">
        <div class="box-root padding-top--48 padding-bottom--24 flex-flex flex-justifyContent--center">
          <h1><a href="../index.php" rel="dofollow"> EgyCar | LogIn</a></h1>
        </div>
        ...
        // get value from input
         ...
         $sql_log = "SELECT * FROM users WHERE 
         phone='$txtphone' AND password = '$txtpass'";
         $res = mysqli_query($con, $sql_log);
        //  loop to get all data 
         while($row = mysqli_fetch_assoc($res)){
            ...
            if($txtphone == $phone && $txtpass == $password){
                header('location: ../index.php');
            }            
            ...
            if($txtphone != $phone || $txtpass != $password) {
             ...
             ?>
                ...
                <div class="field padding-bottom--24">
                  ...
                  <input type="phone" id="phone" name="txtphone">
                </div>
                <div class="field padding-bottom--24">
          ...
          <div class="footer-link padding-top--24">
            <div class="listing padding-top--24 padding-bottom--24 flex-flex center-center">
              <span><a href="../admin/adminlog.php">Admin</a></span>
              <span><a href="../team.html">© EgyCar Team Project</a></span>
