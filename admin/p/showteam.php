...
<?php
    if(isset($_GET['delete'])){
        ...
        mysqli_query($con, "DELETE FROM admin WHERE admin_id  ='$delete_id'");
    ...
    <table>
        <thead>
            <tr>
                ...
                <th colspan="6" style="font-size: 25px;" > اعضاء الفريق : </th><br>
            </tr>
            <tr>
                  <th> الاسم </th>
                  <th> رقم الموبايل </th>
...
if(isset($_SESSION['admin_id'])){
    ...
    while($row = mysqli_fetch_assoc($res)){
        ...
        echo '<td>'. $username .'</td>';
        echo '<td>'. $phone .'</td>';
        echo '<td><a style="color:red;" href="showteam.php?delete='.$id.'">حذف</a></td>';
        echo '</tr>';
